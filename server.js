...
app.use('*' , ( req, res ) => { res.status(404).send({message: 'page not found'})  }) //this is for routs dont exist

app.use((err, req, res , next ) => { // erroer from controller and middlewares
